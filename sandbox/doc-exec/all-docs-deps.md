...
> 原則: <<Constraint Folding>> <<Heavy Function>>
> 状態: <<Twin>>
> 層: <<L4>> <<L3>>
> タグ: <<Emblem>>
> 検証: <<複式数学>>
...
# ai-native-master-bible-en

> 原則: <<Heavy Function>> <<Inline-over-Extract>>
> 状態: <<Twin>> <<REAL>> <<SHADOW>>
> 層: <<Layer>> <<L2>> <<L3>> <<L4>> <<L1>>
> タグ: <<Bridge>> <<Emblem>> <<Tag Immutability>>
> 永続化: <<Event Sourcing>> <<Dumb Relay>>

<!-- @source: AI_NATIVE_MASTER_BIBLE.en.md -->
...
> 原則: <<Heavy Function>> <<Inline-over-Extract>> <<Spotlight>>
> 状態: <<Twin>> <<REAL>> <<SHADOW>>
> 層: <<Layer>> <<L2>> <<L3>> <<L4>> <<L1>>
> タグ: <<Bridge>> <<Emblem>> <<Tag Immutability>>
> 検証: <<Structural Projection>> <<複式数学>>
> 永続化: <<Event Sourcing>> <<Dumb Relay>>
> ツール: <<ai-desk>>
...
> 原則: <<Constraint Folding>>
> 層: <<L3>> <<Layer>> <<L4>>
> タグ: <<Tag Immutability>> <<Emblem>> <<Bridge>>
> 検証: <<Structural Projection>>
> ツール: <<ai-desk>> <<Orchestrator>>
...
> 原則: <<Constraint Folding>> <<Spotlight>>
> 状態: <<SHADOW>> <<REAL>>
> 層: <<Layer>> <<L3>> <<L4>>
> タグ: <<Emblem>> <<Tag Immutability>> <<Bridge>>
> 検証: <<Structural Projection>>
> ツール: <<ai-desk>> <<Orchestrator>>
...
# ai-understanding-manifesto-en

<!-- @source: AI_UNDERSTANDING_MANIFESTO.en.md -->
...
> 原則: <<Heavy Function>> <<Constraint Folding>>
> 状態: <<REAL>> <<Twin>> <<SHADOW>>
> 層: <<Layer>> <<L1>> <<L4>> <<L3>> <<L2>>
> タグ: <<Emblem>> <<Bridge>>
> 永続化: <<Event Sourcing>> <<Dumb Relay>>
...
> 原則: <<Heavy Function>> <<Constraint Folding>> <<Inline-over-Extract>> <<Spotlight>>
> 状態: <<REAL>> <<Twin>> <<SHADOW>>
> 層: <<Layer>> <<L1>> <<L4>> <<L3>> <<L2>>
> タグ: <<Emblem>> <<Bridge>>
> 検証: <<複式数学>>
