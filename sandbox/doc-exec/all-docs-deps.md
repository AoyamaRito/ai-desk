...
**このドキュメントの想定読者は LLM/AI のみです。人間のエンジニアは想定読者ではありません。**
...
> 原則: <<Inline-over-Extract>> <<Spotlight>> <<Heavy Function>> <<Constraint Folding>>
> 状態: <<REAL>> <<Twin>> <<SHADOW>>
> 層: <<Layer>>
> タグ: <<Emblem>> <<Bridge>>
> 検証: <<複式数学>>
> 永続化: <<Dumb Relay>> <<Event Sourcing>>
> ツール: <<doc-exec>> <<ai-desk>> <<ai-eyes>>
...
> 原則: <<Spotlight>> <<Constraint Folding>> <<Heavy Function>>
> 状態: <<SHADOW>> <<REAL>>
> タグ: <<Emblem>>
> ツール: <<doc-exec>> <<ai-desk>>
