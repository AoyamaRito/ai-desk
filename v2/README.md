...
| ファイル | 役割 |
|---|---|
| [`AiRunAndRead_BIBLE.js`](./AiRunAndRead_BIBLE.js) | **思想の正典**(公理 A0〜A8 + Physics + BlockSchema + Taboos + Vocabulary + Rituals) |
...
| [`ai-desk.js`](./ai-desk.js) | 唯一の実装ファイル(Zero-Dep、~2k 行、BIBLE.js を import) |
| [`e2e.js`](./e2e.js) | テスト(111 tests, all green) |
| [`package.json`](./package.json) | ESM 指定、`npm test` 用 |
| [`BIBLE.md`](./BIBLE.md) | 自動生成 SHADOW(`node AiRunAndRead_BIBLE.js export-md` で再生成) |
| `3dplus/` | CPU 3D Twin(81 tests) |
...
node ai-desk.js bible-info                     # 9 公理 / 7 BlockTypes / 7 Taboos / Vocabulary
