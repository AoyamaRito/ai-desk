...
| [`BIBLE.md`](./BIBLE.md) / [`CLAUDE.md`](./CLAUDE.md) / [`MANUAL.md`](./MANUAL.md) / [`AI_ONBOARDING.md`](./AI_ONBOARDING.md) | 自動生成 SHADOW(canonical は `AiRunAndRead_*.js`) |
| [`REFERENCE.md`](./REFERENCE.md) | 自動生成 SHADOW(BIBLE.js の Rituals サブセット、CLI 一覧) |
## サブフォルダ
...
ルートの `ai-desk.test.js` は v1 用、`/PJs/trash/ai-desk-root-2026-05-04/` に退避済。

## SHADOW .md の再生成

```bash
cd v2
node AiRunAndRead_BIBLE.js export-md      > BIBLE.md
node AiRunAndRead_CLAUDE.js export-md     > CLAUDE.md
node AiRunAndRead_MANUAL.js export-md     > MANUAL.md
node AiRunAndRead_ONBOARDING.js export-md > AI_ONBOARDING.md
# REFERENCE.md は BIBLE.js の Rituals から抽出(README に inline コマンド有)
```
