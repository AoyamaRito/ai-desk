# crystallize — Phase 1+2+3 prototype
...
- `main.go` — dispatch (no-arg / --phase2 / --phase3)
- `sameops_cases.go` — Phase 2 cases / harness
- `jsanalysis_cases.go` — Phase 3 cases / harness
- `verify.js` / `verify-phase2.js` / `verify-phase3.js` — JS 側検証
- `go.mod` — module 定義
